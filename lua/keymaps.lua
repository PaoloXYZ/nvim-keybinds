...
keymap("n", "<C-q>", ":BufferKill<CR>", opts)
...
keymap("v", "E", ":move '>+1<CR>gv-gv", opts)
keymap("v", "I", ":move '<-2<CR>gv-gv", opts)
...
-- Insert --
-- "uy" fast is "<ESC>"
keymap("n", "uy", "<ESC>", opts)
keymap("i", "uy", "<ESC>", opts)
keymap("v", "uy", "<ESC>", opts)
keymap("c", "uy", "<ESC>", opts)
